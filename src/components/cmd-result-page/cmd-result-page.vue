<template>
  <div class="cmd-result-page">
    <div class="cmd-wrap">
      <img class="cmd-result-page-image" :src="setSrc" />
      <div class="cmd-result-page-text">{{ setText }}</div>
      <div class="cmd-result-page-subtext">{{ setSubText }}</div>
      <div v-if="defBtn || warnBtn || priBtn" class="cmd-result-page-buttons">
        <button
          v-if="defBtn"
          @tap="$_defBtn"
          class="button"
